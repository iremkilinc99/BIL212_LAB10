...
public class AdjacencyMapGraph<V, E> implements Graph<V, E> {
  ...
  protected Set<Vertex> set = new HashSet<>();
  ...
  public void removeEdge(Edge<E> e) throws IllegalArgumentException {
    ...
    Vertex<V>[] vertices=new InnerVertex[2];
    vertices[0]=edge.endpoints[0];
    vertices[1]=edge.endpoints[1];
    InnerVertex<Vertex<V>>[] verts =(InnerVertex<Vertex<V>>[]) vertices;
  ...
  protected Map<Vertex<V>,Edge<E>> callInnerVertex(Vertex<V> v,boolean isOrNotDirected){
    return new InnerVertex<>(v.getElement(),isOrNotDirected).outgoing;
  }
  ...
  private class InnerVertex<V> implements Vertex<V> {
     ...
     */
    public InnerVertex (Vertex[] a,boolean graphIsDirected) {
